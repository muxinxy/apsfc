...
public class NoticeServlet extends HttpServlet {
	...
	protected void moreNews(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		ArrayList<Notice> newsList = noticeService.findAll();
		// 把查询到的信息添加到request域中
		request.setAttribute("newsList", newsList);
		// 转发到notice.jsp
		request.getRequestDispatcher("/qiantai/news_more.jsp").forward(request, response);
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		} else if (method.equals("moreNews")) {
			moreNews(request, response);
		}
	}
